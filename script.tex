...
responsibility necessitates control: \say{[An] agent can be considered responsible only if he knows the particular
...
%Matthias also introduces the notion of control
%
%
%
%The question is: What happens, when something goes wrong? Who could be
%responsible?
%
...
%
%
%Identifying and defining the changes and challenges are the first steps for
%dealing with them
%
%The purpose of technology is to increase efficiency (\cite[p.
%308]{gunkel2020mind}). It provides strength and precision, optimises time,
%increases memory. Now, with the field of Artificial Intelligence (\acrshort{ai})
%the endeavour is to make technology, well, intelligent.
%In this work
%
%
...
%%technology as something that solves certain problems, the transformative
%%process, that comes with it, challenges us. The changes 
%%
%%
%%
%%
...
%(1) Autonomous Vehicles are being developed to populate the streets and naviagte
%dangerous situations (\cite{faisal2019understanding}).
%(2) Machine Learning Algorithms analyse our behaviour on the internet, recommend
%content that they find we would be interested in and influence us in this
%manner (\cite{milano2020recommender}).
%(3) There is a multitude of applications for ML in health care. We can easily
%imagine that medical practitioners will increasingly rely on tools that diagnose
...
%(4) Autonomous Weapon Systems (\acrshort{aws}) are being developed. The aim is to
...
%Angela Smith describes three different meanings that the sentence
...
Here, \say{\textit{being} responsible [is] conceptually prior to being
\textit{held} responsible} (\cite[p. 439, italics in the
...
moral responsibility exists, because \say{\textit{holding} is conceptually prior
to \textit{being} responsible} (\cite[p. 439, italics in the
...
%To her, moral responsibility is something that inherintly
%belongs to a moral agent
%person
%
...
\say{[f]rustration of these desires} can be suffering (\cite[p.
